...
class FlickrViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
  /**
...
class FlickrRocketRecyclerAdapter(private val list: ArrayList<Any>, private val flag: RecyclerFlags) :
